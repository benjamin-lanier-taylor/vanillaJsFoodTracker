...
// I'm using version (3.5.x) and following the instructions for Webpack/Parcel
// I'm following Jad for making the chart work properly.
// https://www.chartjs.org/docs/3.5.0/getting-started/integration.html#bundlers-webpack-rollup-etc
import Chart from "chart.js/auto";

const API = new FetchWrapper(
  "https://firestore.googleapis.com/v1/projects/jsdemo-3f387/databases/(default)/documents/MYNAMESPACE"
);
